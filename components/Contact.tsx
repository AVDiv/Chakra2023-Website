            ...
            <div className=" w-full h-full flex flex-col justify-center items-center">
                ...
                <motion.div className="text-xl max-w-6xl w-full xl:w-[1156px] text-glow-yellow m-5 mb-10" initial={{ opacity: 0 }} whileInView={{ opacity: [0, 0.7, 0.1, 1] }} transition={{ duration: 1, times: [0, 0.25, 0.26, 1], ease: ["easeIn", 'linear', "easeIn"] }}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 w-full justify-items-center py-5 gap-y-5">
                        ...
                        <ContactCard name="jayasanka ariyarathna " position="- head of program -" image={JayasankaImg} phone="0704821254" email="jayasankaariyaratne@ieee.org" linkedin="https://www.linkedin.com/in/jayasanka-ariyaratne"/>
                        <ContactCard name="pasandi samarasinghe" position="- head of er -" image={PasadiImg} phone="0711476371" email="pasadisamarasinghe@ieee.org" linkedin="https://www.linkedin.com/in/pasadi-samarasinghe"/>
                    </div>
                </motion.div>
            </div>
        </section>
