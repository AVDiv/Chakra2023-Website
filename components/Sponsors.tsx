        ...
        <section className="w-full relative overflow-hidden bg-[#00000050]">
            <div className=" w-full h-full flex flex-col justify-center items-center">
                <div className="w-full flex justify-center">
                    <h1 className="text-3xl text-chakra-red my-10 text-glow-red glitch-text" data-text="$ sPons0Rs"><span>$ <TypeIt options={{ waitUntilVisible: true, cursorChar: '█' }}>sponsors</TypeIt></span></h1>
                </div>
